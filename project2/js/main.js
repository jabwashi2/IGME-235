...
function typeFound(e){
    ...
    //console.log("pokeData.length: " + pokeData.length);
...
/* function emptyArrays(){
    //this will be called everytime the search button is clicked, right before the findPoke function is called
